let g:airline#themes#whiplash#palette = {}
...
let g:airline#themes#whiplash#palette.normal =
    \ airline#themes#generate_color_map(s:N1, s:N2, s:N3, s:N4, s:N5, s:N6)
let g:airline#themes#whiplash#palette.normal_modified = {
...
let g:airline#themes#whiplash#palette.insert =
    \ airline#themes#generate_color_map(s:I1, s:I2, s:I3, s:N4, s:N5, s:N6)
let g:airline#themes#whiplash#palette.insert_paste = {
...
let g:airline#themes#whiplash#palette.replace =
...
let g:airline#themes#whiplash#palette.visual =
...
let g:airline#themes#whiplash#palette.inactive =
  \ airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3, s:IA3, s:IA3, s:IA3)

let g:airline#themes#whiplash#palette.accents = {
            \ 'red': [ '#AF5F5F' , '' , 235 , '', 'bold' ]
            \ }
...
let g:airline#themes#whiplash#palette.ctrlp =
